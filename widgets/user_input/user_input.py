...
class UserInput(QFrame):
    ...
    def __init__(self):
        ...
        self.os_button.clicked.connect(self.toggle_operating_system_interaction.emit)
    ...
    def get_os_button(self):
        return self.os_button
